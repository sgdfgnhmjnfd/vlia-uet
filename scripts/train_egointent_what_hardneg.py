...
def main():
    parser = argparse.ArgumentParser(
        description=(
            "EgoIntent diagnostic: same-task hard-negative objective for predicted WHAT while keeping guided WHY architecture fixed."
        )
    )
    ...
    print("=" * 96)
    print("EGOINTENT WHAT HARD-NEGATIVE GUIDED DIAGNOSTIC")
    print("=" * 96)
    print("device:", device)
    ...
    for condition in args.conditions:
        ...
        for seed in args.seeds:
            ...
            torch.save(
                {
                    "experiment": "egointent_what_hardneg",
                    "condition": condition,
                    "seed": seed,
