...
def main():
    parser = argparse.ArgumentParser(
        description=(
            "EgoIntent diagnostic: direct WHY vs predicted-WHAT-guided vs oracle-WHAT-guided WHY reasoning."
        )
    )
    ...
    parser.add_argument(
        ...
        default=Path(
            "/media/dhqg/d1/vlia_outputs/"
            "egointent_oracle_diagnostic_v1"
        ),
    )
    ...
    print("=" * 96)
    print("EGOINTENT INTENTION-GUIDED ORACLE DIAGNOSTIC")
    print("=" * 96)
    print("device:", device)
    ...
    for condition in args.conditions:
        ...
        for seed in args.seeds:
            ...
            torch.save(
                {
                    "experiment": "egointent_oracle_diagnostic",
                    "condition": condition,
                    "seed": seed,
