...
class EgoIntentModel(nn.Module):
    ...
    IMPORTANT:
        The reasoner only sees PREDICTED WHAT. Ground-truth WHAT is used
        for supervision during training, never as an input at validation.
    """
...
def train_one(
    ...
    if condition == "direct_why":
        ...
        # Train explicit WHAT prediction and the WHY reasoner end-to-end.
...
def main():
    parser = argparse.ArgumentParser(
        description=(
            "EgoIntent guided experiment: direct WHY vs predicted-WHAT-guided WHY reasoning."
        )
    )
    ...
    print("=" * 96)
    print("EGOINTENT PREDICTED-INTENTION-GUIDED REASONING")
    print("=" * 96)
    print("device:", device)
